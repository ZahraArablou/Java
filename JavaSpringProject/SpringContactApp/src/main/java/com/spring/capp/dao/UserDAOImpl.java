...
//this ia repository class because it is communicating with database and handling database
...
@Repository// is for DAO, handling the database must be annoted by the repository
public class UserDAOImpl extends BaseDAO implements UserDAO {
    ...
    public void save(User u) {
        ...
        KeyHolder kh = new GeneratedKeyHolder();//keep the autogenerated key in kh
        SqlParameterSource ps = new MapSqlParameterSource(m);//represents from where the value taken for the  parameters ,
    ...
    public User findById(Integer userId) { 
        ...
        //RowMapper Object ,It maps a record from ResultSet to Domain Object
        return u;
    }
